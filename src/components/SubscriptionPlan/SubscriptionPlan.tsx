      ...
      <div className="flex justify-center items-center py-20">
        <div className="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
          <div className="max-w-sm cursor-pointer bg-white/20 px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <button className="mt-4 font-semibold w-full rounded bg-[#E10856] py-4 hover:opacity-70 transition-all">
              BUY PLAN
            </button>
            <div className="my-4 flex flex-col space-y-3">
              <div className="flex items-center space-x-2">
                <RiVipDiamondLine className="w-6 h-6" />
                <p>Vip plan.</p>
              </div>
              <div className="flex items-center space-x-2">
                <RiHourglass2Line className="w-6 h-6" />
                <p>100 Hour video.</p>
              </div>
            </div>
          </div>
